...
2. **Corbusier** - Split & List - Subset sum for 60 points
...
Week 13 - **Revenge of the Sith** - Union find & keep component size \
Week 14 - **Car Sharing** - MinCost MaxFlow - Multiply the stations for each timestep in time + Additive weight 
